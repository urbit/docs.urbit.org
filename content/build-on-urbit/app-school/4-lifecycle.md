...
We've just bunted the `$state-0` type, which will produce `[%0 val=0]`, pinning it to the head of the subject. Then, we've use [tistar](../../hoon/rune/tis.md#tistar) (`=*`) to give it a name of `.state`.
