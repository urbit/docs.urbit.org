...
There's another way around this, which will also be illuminating:  build it from the [ground up](../../nock).
...
- Write your own jet, following the [tutorial](../../build-on-urbit/runtime/guides/jetting.md).
