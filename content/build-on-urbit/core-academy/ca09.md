---
description: >-
  Core Academy lesson on HTTP vanes covering the Eyre vane's HTTP server functionality, the Iris vane's HTTP client operations, web request/response patterns, authentication mechanisms, and integration with Gall agents for web services.
---
...
- [“Guide:  Noun channels”](../../urbit-os/kernel/eyre/noun-channels.md)
...
- Examine the [“Eyre Guide:  Generators”](../../urbit-os/kernel/eyre/guide.md#generators) example.
...
- Examine the [“HTTP API”](../../urbit-os/base/threads/http-api.md) example.
...
- Examine the [“Iris Guide:  Example”](../../urbit-os/kernel/iris/example.md) thread.
