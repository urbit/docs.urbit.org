...
### Serving a Web Page {#serving-a-web-page}
...
Thanks to the mark system and `++find-channel-mode`, it is straightforward on Urbit's side to implement noun channels. However, on the other side you need something that speaks nouns, such as [`noun.py`](https://github.com/urbit/build-on-urbit/tools/blob/master/pkg/pynoun/noun.py).

- [“Guide:  Noun channels”](../../urbit-os/kernel/eyre/guides/noun-channels.md)
...
- Examine the [“Eyre Guide:  Generators”](../../urbit-os/kernel/eyre/guides/guide.md#generators) example.
...
- Examine the [“HTTP API”](../../urbit-os/base/threads/guides/http-api.md) example.
...
### Vere I/O Driver:  `vere/io/http.c` {#vere-io-driver-vereiohttpc}
...
- Examine the [“Iris Guide:  Example”](../../urbit-os/kernel/iris/examples/example.md) thread.
...
### Vere I/O Driver:  `vere/io/cttp.c` {#vere-io-driver-vereiocttpc}
