...
- [`%d`: get desk of app](../../urbit-os/kernel/gall/reference/scry.md#d-get-desk-of-app)
- [`%e`: running apps](../../urbit-os/kernel/gall/reference/scry.md#e-running-apps)
- [`%f`: nonces of apps](../../urbit-os/kernel/gall/reference/scry.md#f-nonces-of-apps)
- [`%n`: get nonce of subscription](../../urbit-os/kernel/gall/reference/scry.md#n-get-nonce-of-subscription)
- [`%t`: remote scry subpaths](../../urbit-os/kernel/gall/reference/scry.md#t-remote-scry-subpaths)
- [`%u`: check if installed](../../urbit-os/kernel/gall/reference/scry.md#u-check-if-installed)
- [`%w`: latest revision of path](../../urbit-os/kernel/gall/reference/scry.md#w-latest-revision-of-path)
- [`%x`: remote scry file](../../urbit-os/kernel/gall/reference/scry.md#x-remote-scry-file)
- [`%z:` hash of value at path](../../urbit-os/kernel/gall/reference/scry.md#z-hash-of-value-at-path)
...
- [“Software Distribution · Userspace”](../guides/guides/software-distribution.md)
...
- [“Debugging Wrapper”](../guides/examples/dbug.md)
