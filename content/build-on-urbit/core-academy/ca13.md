...
* [“Comet self-attestation”](../../urbit-os/kernel/ames/guides/cryptography.md#comets)
...
* Examine the [`%step` exercise](../../urbit-os/kernel/jael/examples/examples.md#step) in the Jael docs.
