---
description: >-
  Advanced core concepts including doors (gate-building gates), doors as parametrized cores with sample data, working with `+map`s (key-value stores), and techniques for managing stateful computation patterns.
---
