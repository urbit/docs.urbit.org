---
description: >-
  Documentation application for distributing docs with Urbit desks, supporting multiple file formats (txt, udon, gmi, html), automatic detection, and structured browsing through the %docs app.
---
