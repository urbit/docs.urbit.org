...
[zapgar](/language/hoon/reference/rune/zap#-zapgar) (`!>`) rune like
`!>(some-data)`, and unpacked with the
[zapgal](/language/hoon/reference/rune/zap#-zapgal) (`!<`) rune like
...
[wuthep](/language/hoon/reference/rune/wut#--wuthep) (`?-`) expression can switch on
...
The next line uses [tistar](/language/hoon/reference/rune/tis#-tistar) to give it
...
irregular syntax for the [buccab](/language/hoon/reference/rune/buc#_-buccab) (`$_`)
...
[zapgar](/language/hoon/reference/rune/zap#-zapgar) (`!>`) rune, like `!>(state)`.
...
[zapgal](/language/hoon/reference/rune/zap#-zapgal) (`!<`) rune, and then typically
you'd test its version with a [wuthep](/language/hoon/reference/rune/wut#--wuthep)
(`?-`) expression.
...
[tistar](/language/hoon/reference/rune/tis#-tistar) (`=*`) to give it a name of
`state`.
...
[centis](/language/hoon/reference/rune/cen#-centis) (`%=`) rune. You'll likely be
