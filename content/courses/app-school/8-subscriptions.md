...
- If you'd like, try going back to [lesson 6](6-pokes) (on pokes) and modifying the agents with an appropriate permission system, and also try running them on separate ships.
