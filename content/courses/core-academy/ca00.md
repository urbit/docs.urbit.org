...
- [Nock Definition](../../nock/reference/definition)
...
There's another way around this, which will also be illuminating:  build it from the [ground up](../../nock/examples/README.md).
