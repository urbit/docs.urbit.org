# 2. Building Hoon {#2-building-hoon}
...
#### `++slap`:  Envase Hoon {#slap-envase-hoon}
...
#### `++slop`:  Combine Vases {#slop-combine-vases}
...
#### Vase Algebra Operations {#vase-algebra-operations}
...
#### `++slam`:  Slam Gate with Sample {#slam-slam-gate-with-sample}
...
#### `++slot`:  Retrieve Noun {#slot-retrieve-noun}
...
#### Tutorial:  Finding the Sample {#tutorial-finding-the-sample}
