...
The core variance is repeated because of the dry/wet gate distinction.  [Core variance](urbit-docs/guides/core/hoon-school/R-metals) starts to make more sense once you've popped the cover off of cores this way.
...
- [Hoon School, “Generic and Variant Cores”](urbit-docs/guides/core/hoon-school/R-metals)
...
- [`++on`](urbit-docs/reference/hoon/zuse/2m) provides the services for `++mop` ordered maps.
...
- Various types, notably [structured text support](urbit-docs/guides/additional/app-workbook/track7).
...
- [`++enjs:format`](urbit-docs/reference/hoon/zuse/2d_1-5) supports noun-to-JSON conversions.
- [`++dejs:format`](urbit-docs/reference/hoon/zuse/2d_6) are the reparsers (see `++de:json:html` for the parser).  Notably this is where many noun-to-text converters live.
- [`++dejs-soft`](urbit-docs/reference/hoon/zuse/2d_7) offers non-crashing versions of the `++dejs` arms (thus, returning `unit`s).
...
- [`++json:html`](urbit-docs/reference/hoon/zuse/2e_2-3) tools are reparsers (see `++dejs:format` for the reparsers).
