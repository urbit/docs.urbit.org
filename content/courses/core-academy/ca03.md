# 4. Arvo I:  The Main Sequence {#4-arvo-i-the-main-sequence}
...
##### Aside:  Metacards & `;;` micmic {#aside-metacards-micmic}
...
#### `++va`:  Vane Operations {#va-vane-operations}
