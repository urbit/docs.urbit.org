# 7. Vere II:  The Loom {#7-vere-ii-the-loom}
...
```c
# define u3_assert(x)                       \ {#define-u3_assertx-}
    do {                                    \
      if (!(x)) {                           \
        fflush(stderr);                     \
...
#### Example:  `|meld` Trace {#example-meld-trace}
