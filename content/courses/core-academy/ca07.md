...
A **vane** is an [Arvo](urbit-docs/reference/glossary/arvo) kernel module that performs essential system operations. The vanes are:

- [Ames](urbit-docs/reference/glossary/ames), the peer-to-peer networking vane.
- [Behn](urbit-docs/reference/glossary/behn), the timer vane.
- [Clay](urbit-docs/reference/glossary/clay), the filesystem, revision-control and build system vane.
- [Dill](urbit-docs/reference/glossary/dill), the terminal-driver vane.
- [Eyre](urbit-docs/reference/glossary/eyre), the HTTP vane.
- [Gall](urbit-docs/reference/glossary/gall), the application vane.
- [Iris](urbit-docs/reference/glossary/iris), the server HTTP vane.
- [Jael](urbit-docs/reference/glossary/jael), the security vane.
- [Khan](urbit-docs/reference/glossary/khan), the control vane.
- [Lick](urbit-docs/reference/glossary/Lick), the interprocess communication (IPC) vane.
...
- [“Behn Overview”](urbit-docs/reference/arvo/dill/behn)
...
- [~lagrev-nocfep, “The Nested Core Design Pattern (As Seen Through `++abet`)”](urbit-docs/blog/nested-core-pattern)
...
- [“Dill Overview”](urbit-docs/reference/arvo/dill/dill)
