...
- [“Guide:  Noun channels”](urbit-docs/system/kernel/eyre/guides/noun-channels)
...
- Examine the [“Eyre Guide:  Generators”](urbit-docs/system/kernel/eyre/guides/guide#generators) example.
...
- Examine the [“HTTP API”](urbit-docs/userspace/threads/guides/http-api) example.
...
- Examine the [“Iris Guide:  Example”](urbit-docs/system/kernel/iris/examples/example) thread.
