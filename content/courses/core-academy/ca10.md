...
- [“Clay:  Architecture”](urbit-docs/system/kernel/clay/guides/architecture)
...
- [“`%warp` - Remote”](urbit-docs/system/kernel/clay/examples/examples#warp-1---remote)
...
-   [`%d` - List desks.](urbit-docs/reference/arvo/clay/scry#d---list-desks)
-   [`%p` - Return file permissions.](urbit-docs/reference/arvo/clay/scry#p---file-permissions)
-   [`%r` - Return file as vase.](urbit-docs/reference/arvo/clay/scry#r---file-as-vase)
-   [`%t` - List files.](urbit-docs/reference/arvo/clay/scry#t---list-files)
-   [`%u` - Check if resource exists.](urbit-docs/reference/arvo/clay/scry#u---check-exists)
-   [`%v` - Retrieve desk state.](urbit-docs/reference/arvo/clay/scry#v---desk-state)
-   [`%w` - Show revision number of a given `case`.](urbit-docs/reference/arvo/clay/scry#w---revision-number)
-   [`%x` - Read file.](urbit-docs/reference/arvo/clay/scry#x---read-file)
-   [`%y` - Read `arch` (file hash or directory contents).](urbit-docs/reference/arvo/clay/scry#y---read-arch)
-   [`%z` - Show content hash.](urbit-docs/reference/arvo/clay/scry#z---content-hash)
...
- [“Merge Desks”](urbit-docs/system/kernel/clay/reference/tasks#merge-desks)
- [“`%merg`”](urbit-docs/system/kernel/clay/examples/examples#merg)
...
-   [`%a` - Build Hoon code.](urbit-docs/reference/arvo/clay/scry#a---build-hoon)
...
- [“Using Marks”](urbit-docs/system/kernel/clay/guides/marks/using-marks)

**Build cares, Part II**

-   [`%b` - Produce dynamic mark core.](urbit-docs/reference/arvo/clay/scry#b---dyn-mark-core)
-   [`%c` - Produce dynamic mark conversion gate.](urbit-docs/reference/arvo/clay/scry#c---dyn-mark-convert)
-   [`%e` - Produce static mark core.](urbit-docs/reference/arvo/clay/scry#e---static-mark-core)
-   [`%f` - Produce static mark conversion gate.](urbit-docs/reference/arvo/clay/scry#f---stat-mark-convert)
...
-   [`%s` - Perform miscellaneous internal scries.](urbit-docs/reference/arvo/clay/scry#s---misc-scries)
...
- [“Permissions”](urbit-docs/system/kernel/clay/reference/tasks#permissions)
...
- [`%tomb` - Tombstoning](urbit-docs/system/kernel/clay/reference/tasks#tomb---tombstoning)
