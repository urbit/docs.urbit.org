...
- [“`%warp` - Remote”](../../system/kernel/clay/examples/examples.md#warp-1---remote) "BROKEN_LINK"
...
- [“Merge Desks”](../../system/kernel/clay/reference/tasks.md#merge-desks) "BROKEN_LINK"
- [“`%merg`”](../../system/kernel/clay/examples/examples.md#merg) "BROKEN_LINK"
...
- [“Permissions”](../../system/kernel/clay/reference/tasks.md#permissions) "BROKEN_LINK"
...
> Tombstoning is the deletion of data for old desk revisions. Clay has a single `%tomb` `task`, but its [`clue`](../../system/kernel/clay/reference/data-types.md#clue) "BROKEN_LINK" has a number of different possible actions:
...
- [`%tomb` - Tombstoning](../../system/kernel/clay/reference/tasks.md#tomb---tombstoning) "BROKEN_LINK"
