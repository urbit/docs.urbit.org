# 11. Vanes IV:  Clay {#11-vanes-iv-clay}
...
- [“Clay:  Architecture”](../../system/kernel/clay/guides/architecture.md)
...
- [“`%warp` - Remote”](../../system/kernel/clay/examples/examples.md#warp-1---remote)
...
- [“Merge Desks”](../../system/kernel/clay/reference/tasks.md#merge-desks)
- [“`%merg`”](../../system/kernel/clay/examples/examples.md#merg)
...
- [“Permissions”](../../system/kernel/clay/reference/tasks.md#permissions)
...
> Tombstoning is the deletion of data for old desk revisions. Clay has a single `%tomb` `task`, but its [`clue`](../../system/kernel/clay/reference/data-types.md#clue) has a number of different possible actions:
...
- [`%tomb` - Tombstoning](../../system/kernel/clay/reference/tasks.md#tomb---tombstoning)
