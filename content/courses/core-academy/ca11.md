# 12. Vanes V:  Gall and Userspace {#12-vanes-v-gall-and-userspace}
...
- [`|~` barsig](../../language/hoon/reference/rune/bar.md#-barsig) yields an iron gate.
- [`^|` ketbar](../../language/hoon/reference/rune/ket.md#-ketbar) yields an iron core from a gold core.
...
(Variance again:  [`^?` ketwut](../../language/hoon/reference/rune/ket.md#-ketwut) is for a lead/bivariant core.)
...
- [`%d`: get desk of app](../../system/kernel/gall/reference/scry.md#d-get-desk-of-app)
- [`%e`: running apps](../../system/kernel/gall/reference/scry.md#e-running-apps)
- [`%f`: nonces of apps](../../system/kernel/gall/reference/scry.md#f-nonces-of-apps)
- [`%n`: get nonce of subscription](../../system/kernel/gall/reference/scry.md#n-get-nonce-of-subscription)
- [`%t`: remote scry subpaths](../../system/kernel/gall/reference/scry.md#t-remote-scry-subpaths)
- [`%u`: check if installed](../../system/kernel/gall/reference/scry.md#u-check-if-installed)
- [`%w`: latest revision of path](../../system/kernel/gall/reference/scry.md#w-latest-revision-of-path)
- [`%x`: remote scry file](../../system/kernel/gall/reference/scry.md#x-remote-scry-file)
- [`%z:` hash of value at path](../../system/kernel/gall/reference/scry.md#z-hash-of-value-at-path)
...
- [“Gall Scry Reference”](../../system/kernel/gall/reference/scry.md)
