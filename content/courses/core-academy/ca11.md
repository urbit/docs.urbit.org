...
(Variance again:  [`^?` ketwut](urbit-docs/language/hoon/reference/rune/ket#-ketwut) is for a lead/bivariant core.)
...
- [`%d`: get desk of app](urbit-docs/system/kernel/gall/reference/scry#d-get-desk-of-app)
- [`%e`: running apps](urbit-docs/system/kernel/gall/reference/scry#e-running-apps)
- [`%f`: nonces of apps](urbit-docs/system/kernel/gall/reference/scry#f-nonces-of-apps)
- [`%n`: get nonce of subscription](urbit-docs/system/kernel/gall/reference/scry#n-get-nonce-of-subscription)
- [`%t`: remote scry subpaths](urbit-docs/system/kernel/gall/reference/scry#t-remote-scry-subpaths)
- [`%u`: check if installed](urbit-docs/system/kernel/gall/reference/scry#u-check-if-installed)
- [`%w`: latest revision of path](urbit-docs/system/kernel/gall/reference/scry#w-latest-revision-of-path)
- [`%x`: remote scry file](urbit-docs/system/kernel/gall/reference/scry#x-remote-scry-file)
- [`%z:` hash of value at path](urbit-docs/system/kernel/gall/reference/scry#z-hash-of-value-at-path)
...
- [“Gall Scry Reference”](urbit-docs/system/kernel/gall/reference/scry)
...
- [“Software Distribution · Userspace”](urbit-docs/userspace/apps/guides/software-distribution)
