...
- [“Khan:  API Reference”](../../system/kernel/khan/reference/tasks.md) "BROKEN_LINK"
...
- [`%a` - Read ports](../../system/kernel/lick/reference/scry.md#a---read-ports) "BROKEN_LINK"
- [`%d` - Port owner](../../system/kernel/lick/reference/scry.md#d---port-owner) "BROKEN_LINK"
- [`%u` - Port existance](../../system/kernel/lick/reference/scry.md#u---port-existance) "BROKEN_LINK"
