...
identity. You just need to have [installed the Urbit binary](/manual/getting-started/self-hosted/cli).
...
The desks ending in `-dev`, like `base-dev` and `landscape-dev`, contain files for
