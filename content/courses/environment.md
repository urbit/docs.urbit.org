...
Because such a ship has no presence on the network, you don't need an Azimuth identity. You just need to have [installed the Urbit binary](urbit-docs/manual/getting-started/self-hosted/cli).
...
Other points can be calculated using [the layout of Azimuth](urbit-docs/courses/hoon-school/C-azimuth#the-urbit-address-space).
