...
| ------- | -------------------------------------------------------- | ------------------------------------------------------ |
| Layer 1 | OpenSea [Urbit ID: Planet](https://opensea.io/collection/urbit-id-planet) and [Urbit ID](https://opensea.io/collection/urbit-id-planet) collections. | The largest NFT marketplace. Accepts ETH. |
