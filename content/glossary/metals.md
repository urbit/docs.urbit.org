...
"Variance" describes the four possible relationships that type rules for [cores](core) are able to have to each other. [Hoon](hoon) imaginatively designates these by **metals**. Briefly:
