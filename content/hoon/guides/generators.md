...
`%ask` generators return `sole-effect`s.  For more information on these, consult the [guide on command-line agents](../../build-on-urbit/guides/guides/cli-tutorial.md).
...
The [`+dbug` agent](../../build-on-urbit/guides/examples/dbug.md) is invoked against an agent to display internal state.

Any app can implement generators to wrap raw pokes (see [`%ahoy`](../../build-on-urbit/guides/examples/ahoy.md) for instance).
