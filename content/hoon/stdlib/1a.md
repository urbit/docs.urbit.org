---
description: "Reference for basic arithmetic functions in Hoon including addition, subtraction, multiplication, division, and comparison operations for unsigned integers."
layout:
  title:
    visible: true
  description:
