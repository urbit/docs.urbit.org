---
description: >-
  Reference for fundamental container types and molds in Hoon including pair, list, unit, tree, gate, and other essential type definitions.
---
...
A `bloq` of 3 has a bitwidth of 8. ($$2^3$$ bits; can represent $$2^{2^3}=256$$ different values.)
And so on.
