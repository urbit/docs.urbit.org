---
description: "JSON encoding and decoding functions. Print JSON to cord, parse JSON from cord. Part of format library."
layout:
  title:
    visible: true
  description:
