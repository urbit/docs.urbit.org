...
touched on here. Instead, see the [Parsing](/language/hoon/guides/parsing) guide.
...
A [`cord`](/language/hoon/reference/stdlib/2q#cord) has an aura of `@t`. It denotes
...
A [`knot`](/language/hoon/reference/stdlib/2q#knot) has an aura of `@ta`, and is a
...
A [`term`](/language/hoon/reference/stdlib/2q#term) has an aura of `@tas`, and is a
...
[`+sane`](/language/hoon/reference/stdlib/4b#sane) and
[`+sand`](/language/hoon/reference/stdlib/4b#sane).
...
A [`tape`](/language/hoon/reference/stdlib/2q#tape) is the other
...
[Auras](/language/hoon/reference/auras#bitwidth) documentation for
...
[`+scow`](/language/hoon/reference/stdlib/4m#scow) function to
...
functions for this purpose: [`+crip`](/language/hoon/reference/stdlib/4b#crip) and
[`+trip`](/language/hoon/reference/stdlib/4b#trip). The former converts a `tape` to
...
[scry](/system/kernel/arvo/guides/scry) [`path`](/language/hoon/reference/stdlib/2q#path)
or just a `path` in general. There are two main functions for this purpose:
[`+scot`](/language/hoon/reference/stdlib/4m#scot) and
[`+scow`](/language/hoon/reference/stdlib/4m#scow). The former produces a `knot`,
...
[`+spat`](/language/hoon/reference/stdlib/4m#spat) and
...
functions: [`+slat`](/language/hoon/reference/stdlib/4m#slat),
[`+slav`](/language/hoon/reference/stdlib/4m#slav), and
[`+slaw`](/language/hoon/reference/stdlib/4m#slaw). Additionally, there is
[`+stab`](/language/hoon/reference/stdlib/4m#stab) for decoding a cord to a path.
...
- [stdlib 2b: List logic](/language/hoon/reference/stdlib/2b) - Standard library
  functions for manipulating lists, which are useful for dealing with tapes.

- [stdlib 2q: Molds and Mold-builders](/language/hoon/reference/stdlib/2q) - Several
  text types are defined in this section of the standard library.

- [stdlib 4b: Text processing](/language/hoon/reference/stdlib/4b) - Standard
  library functions for manipulating and converting tapes and strings.

- [stdlib 4m: Formatting functions](/language/hoon/reference/stdlib/4m) - Standard
