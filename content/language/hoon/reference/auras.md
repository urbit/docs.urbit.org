...
Auras are system of nested "soft types" on [atoms](urbit-docs/glossary/atom) that are used to track metadata about how a particular atom is to be interpreted. This is used for type checking as well as pretty printing.

You can learn more about auras in [Hoon school](urbit-docs/courses/hoon-school/B-syntax#nouns).
