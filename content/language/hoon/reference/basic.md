...
(For an introduction on how to use Hoon's type system, see [Chapter 4](urbit-docs/courses/hoon-school/E-types) of the Hoon tutorial.)
...
As noted, this is a simplified version of `type`.  We undo and explain the simplifications in the [advanced types](urbit-docs/language/hoon/reference/advanced) section.
