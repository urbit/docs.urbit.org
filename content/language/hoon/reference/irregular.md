...
When in doubt, you can use the [`!,` zapcom](urbit-docs/language/hoon/reference/rune/zap#-zapcom) rune to determine the AST to which Hoon parses an expression.
...
| Form | Regular Form |
| ---- | ------------ |
| `_foo` | [`$_`](urbit-docs/language/hoon/reference/rune/buc#_-buccab), normalizes to an example |
| `foo=bar` | [`$=`](urbit-docs/language/hoon/reference/rune/buc#-buctis), wraps a face around a value |
| `?(%foo %bar %baz)` | [`$?`](urbit-docs/language/hoon/reference/rune/buc#-bucwut), forms a type union |
| `(fun a b c)` | [`%:`](urbit-docs/language/hoon/reference/rune/cen#-cencol), calls a gate with n arguments |
| `~(arm core arg)` | [`%~`](urbit-docs/language/hoon/reference/rune/cen#-censig), pulls an arm in a door |
| `foo(x 1, y 2, z 3)` | [`%=`](urbit-docs/language/hoon/reference/rune/cen#-centis), resolve a wing with changes |
| `[a b c]` | [`:*`](urbit-docs/language/hoon/reference/rune/col#-coltar) or [`$:`](urbit-docs/language/hoon/reference/rune/buc#-buccol), constructs _n_-tuple in normal mode or its structure in structure mode |
| `~[a b c]` | [`:~`](urbit-docs/language/hoon/reference/rune/col#-colsig), constructs null-terminated list |
| `+(42)` | [`.+`](urbit-docs/language/hoon/reference/rune/dot#-dotlus), increments with Nock 4 |
| `=(a b)` | [`.=`](urbit-docs/language/hoon/reference/rune/dot#-dottis), tests for equality wiht Nock 5 |
| `` `foo` bar`` | [`^-`](urbit-docs/language/hoon/reference/rune/ket#--kethep), typecasts by explicit type label |
| `foo=bar` | [`^=`](urbit-docs/language/hoon/reference/rune/ket#-kettis), binds name to value |
| `*foo` | [`^*`](urbit-docs/language/hoon/reference/rune/ket#-kettar), bunts (produces default mold value) |
| `,foo` | [`^:`](urbit-docs/language/hoon/reference/rune/ket#-ketcol), produces “factory” gate for type |
| `:(fun a b c d)` | [`;:`](urbit-docs/language/hoon/reference/rune/mic#-miccol), calls binary function as _n_-ary function |
| `foo:bar` | [`=<`](urbit-docs/language/hoon/reference/rune/tis#-tisgal), composes two expressions, inverted |
| `\|(foo bar baz)` | [`?\|`](urbit-docs/language/hoon/reference/rune/wut#-wutbar), logical OR (loobean) |
| `&(foo bar baz)` | [`?&`](urbit-docs/language/hoon/reference/rune/wut#-wutpam), logical AND (loobean) |
| `!foo` | [`?!`](urbit-docs/language/hoon/reference/rune/wut#-wutzap), logical NOT (loobean) |
...
[docs](urbit-docs/language/hoon/reference/rune/dot#-dotlus) \\+
...
[docs](urbit-docs/language/hoon/reference/rune/dot#-dottis) \\=
...
[docs](urbit-docs/language/hoon/reference/rune/mic#-miccol) \\:
...
[docs](urbit-docs/language/hoon/reference/rune/col#--colhep) \\[\\]\\^\\/\\+\\\`\\~
...
[docs](urbit-docs/language/hoon/reference/rune/tis#-tisgal) \\:
...
[docs](urbit-docs/language/hoon/reference/rune/bar) \\$
...
[docs](urbit-docs/language/hoon/reference/rune/cen#-centis) \\(\\)
...
[docs](urbit-docs/language/hoon/reference/rune/cen#-censig) \\~
...
[docs](urbit-docs/language/hoon/reference/rune/cen#-cenhep) \\(\\)
...
[docs](urbit-docs/language/hoon/reference/rune/buc#-bucwut) \\?
...
[docs](urbit-docs/language/hoon/reference/rune/buc#_-buccab) \\\_
...
[docs](urbit-docs/language/hoon/reference/rune/buc#-buctis)  \\=
...
[docs](urbit-docs/language/hoon/reference/rune/wut#-wutzap) \\!
...
[docs](urbit-docs/language/hoon/reference/rune/wut#-wutpam) \\&
...
[docs](urbit-docs/language/hoon/reference/rune/wut#-wutbar) \\|
...
[docs](urbit-docs/language/hoon/reference/rune/ket#-ketcol) \\,
...
[docs](urbit-docs/language/hoon/reference/rune/ket#--kethep) \\\`
...
[docs](urbit-docs/language/hoon/reference/rune/ket#-kettar) \\\*
...
[docs](urbit-docs/language/hoon/reference/rune/ket#-kettis) \\=
...
See [%sand](urbit-docs/language/hoon/reference/rune/constants#warm) for other irregular definitions of atoms.
...
[docs](urbit-docs/language/hoon/reference/limbs/limb) \\+\\.\\^\\-
...
[docs](urbit-docs/language/hoon/reference/limbs/wing) \\.
...
- `>a b c<` produces a [tank](urbit-docs/language/hoon/reference/stdlib/2q/#tank) of the output of the contents (wrapped in cell if more than 1 item), formatted in pretty-print.
...
- `<a b c>` produces a [tape](urbit-docs/language/hoon/reference/stdlib/2q/#tape) of the tank above (ie `<1 2 3>` is same as `~(ram re >1 2 3<)`).
