...
- [`++cue`](stdlib/2p#cue), unpack a jammed noun
- [`++jam`](stdlib/2p#jam), pack a jammed noun
- [`++mat`](stdlib/2p#mat), length-encode a noun
- [`++rub`](stdlib/2p#rub), length-decode a noun
