...
- [`++cue`](urbit-docs/language/hoon/reference/stdlib/2p#cue), unpack a jammed noun
- [`++jam`](urbit-docs/language/hoon/reference/stdlib/2p#jam), pack a jammed noun
- [`++mat`](urbit-docs/language/hoon/reference/stdlib/2p#mat), length-encode a noun
- [`++rub`](urbit-docs/language/hoon/reference/stdlib/2p#rub), length-decode a noun

`++jam` and `++cue` are critically important for noun communication operations, including the `%lick` vane, the `%khan` vane, and [noun channels in `%eyre`](urbit-docs/system/kernel/eyre/guides/noun-channels).
