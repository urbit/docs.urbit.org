...
[`Atom`](urbit-docs/glossary/atom) representing block size. A block of size `a` has a bitwidth of `2^a`.
...
See the [bit arithmetic](urbit-docs/language/hoon/reference/stdlib/2c) section for operations that use `bloq`s.
...
A [`core`](urbit-docs/glossary/core) with one arm, `$`--the empty name--which transforms a sample noun into a product noun. If used dryly as a type, the subject must have a sample type of `*`.
...
See also: [`++lift`](urbit-docs/language/hoon/reference/stdlib/2a#lift), [`++cork`](urbit-docs/language/hoon/reference/stdlib/2n#cork)
...
See also: [`++turn`](urbit-docs/language/hoon/reference/stdlib/2b#turn), [`++snag`](urbit-docs/language/hoon/reference/stdlib/2b#snag)
...
Faceless [`list`](urbit-docs/language/hoon/reference/stdlib/1c#list)

A mold generator. A [`list`](urbit-docs/language/hoon/reference/stdlib/1c#list) without the faces `i` and `t`.
...
Mold of pair of [`list`](urbit-docs/language/hoon/reference/stdlib/1c#list) and type

A mold generator. Produces a tuple of a [`list`](urbit-docs/language/hoon/reference/stdlib/1c#list) of `item` and the mold of `state`.
...
[`Core`](urbit-docs/glossary/core) with one arm `$`

A trap is a [`core`](urbit-docs/glossary/core) with one arm `$`.
...
See also: [`++bind`](urbit-docs/language/hoon/reference/stdlib/2a#bind)
