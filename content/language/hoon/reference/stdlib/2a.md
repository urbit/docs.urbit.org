...
`b` is a function that accepts a [`noun`](/reference/glossary/noun) and produces a [`unit`](/language/hoon/reference/stdlib/1c#unit).
...
Replaces an empty [`unit`](/language/hoon/reference/stdlib/1c#unit) `b` with the product of a called [`trap`](/reference/glossary/trap)
...
Either a [`noun`](/reference/glossary/noun) `b` or the unwrapped value of [`unit`](/language/hoon/reference/stdlib/1c#unit) `a`.
...
Takes any [`noun`](/reference/glossary/noun) `a` and produces a [`unit`](/language/hoon/reference/stdlib/1c#unit) with the value set to `a`.
