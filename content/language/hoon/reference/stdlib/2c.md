...
Computes the result of `2^a`, where `a` is a block size (see [$bloq](urbit-docs/language/hoon/reference/stdlib/1c#bloq)), producing an atom.
...
`a` is a block size (see [`$bloq`](urbit-docs/language/hoon/reference/stdlib/1c#bloq)).

`b` is a `list` of length-value pairs, `p` and `q`:

- `p` is a [step](urbit-docs/language/hoon/reference/stdlib/1c/#step).
- `q` is a `@`.
...
`a` is a block size (see [`$bloq`](urbit-docs/language/hoon/reference/stdlib/1c)).

`[b c]` where:

- `b` is a [step](urbit-docs/language/hoon/reference/stdlib/1c#step).
- `c` is a [step](urbit-docs/language/hoon/reference/stdlib/1c#step).
...
`a` is an atom slice specifier (see [`$bite`](urbit-docs/language/hoon/reference/stdlib/1c#bite)), which is a block size (see [`$bloq`](urbit-docs/language/hoon/reference/stdlib/1c#bloq)) with optional block count.
...
`boz` is a block size with optional block count (see [`$bloq`](urbit-docs/language/hoon/reference/stdlib/1c#bloq)).
...
`a` is a [$bloq](urbit-docs/language/hoon/reference/stdlib/1c#bite) (block size).

`[b c d]` where:

- `b` is a [step](urbit-docs/language/hoon/reference/stdlib/1c#step) specifying the number of `bloq`s to offset.
- `b` is a [step](urbit-docs/language/hoon/reference/stdlib/1c#step) specifying the number of `bloq`s to replace.
- `d` is the donor atom.
...
`b` is a `bloq`. (see [`$bloq`](urbit-docs/language/hoon/reference/stdlib/1c#bloq))
