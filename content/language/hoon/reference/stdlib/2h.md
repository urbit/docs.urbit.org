...
See section [`2f`](urbit-docs/language/hoon/reference/stdlib/2f) for more information on noun ordering.
...
For more on the tree addressing system, see section [1b](urbit-docs/language/hoon/reference/stdlib/1b).
