...
See also: [`ja`](urbit-docs/language/hoon/reference/stdlib/2j#ja), [`by`](urbit-docs/language/hoon/reference/stdlib/2i), [`map`](#map), [lists](urbit-docs/language/hoon/reference/stdlib/2b)
...
See also: [`ju`](urbit-docs/language/hoon/reference/stdlib/2j#ju), [`by`](urbit-docs/language/hoon/reference/stdlib/2i), [`map`](#map), [`set`](#set)
...
See also: [`by`](urbit-docs/language/hoon/reference/stdlib/2i)
...
See also: [`+to`](urbit-docs/language/hoon/reference/stdlib/2k#to)
...
See also: [`+in`](urbit-docs/language/hoon/reference/stdlib/2h)
