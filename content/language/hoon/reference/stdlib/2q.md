...
[`trip`](urbit-docs/language/hoon/reference/stdlib/4b#trip) converts from `cord` to `tape`, and [`crip`](urbit-docs/language/hoon/reference/stdlib/4b#crip) converts from `tape` to `cord`.
...
See also: [`year`](urbit-docs/language/hoon/reference/stdlib/3c#year), [`yore`](urbit-docs/language/hoon/reference/stdlib/3c#yore)
