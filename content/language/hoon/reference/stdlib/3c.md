...
Produce a [`$tarp`](urbit-docs/language/hoon/reference/stdlib/2q#tarp) time format from a`@da`.
...
Accepts a [`$tarp`](urbit-docs/language/hoon/reference/stdlib/2q#tarp), a parsed daily time, and produces a `@da`.
