...
Used in `++coin`. Convenience methods [`++scot`](urbit-docs/language/hoon/reference/stdlib/4m#scot) and [`++scow`](urbit-docs/language/hoon/reference/stdlib/4m#scow) print dimes as `++cord` and `++tape`, respectively. [`++slat`](urbit-docs/language/hoon/reference/stdlib/4m#slat), [`++slav`](urbit-docs/language/hoon/reference/stdlib/4m#slav), and [`++slaw`](urbit-docs/language/hoon/reference/stdlib/4m#slaw) are used to parse atoms of specific auras.
