...
Used in `++coin`. Convenience methods [`++scot`](4m#scot) and [`++scow`](4m#scow) print dimes as `++cord` and `++tape`, respectively. [`++slat`](4m#slat), [`++slav`](4m#slav), and [`++slaw`](4m#slaw) are used to parse atoms of specific auras.
