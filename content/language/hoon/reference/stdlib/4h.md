...
Parses ASCII character 92, the backslash. Note the extra `\` in the calling of `bas` with [`just`](urbit-docs/language/hoon/reference/stdlib/4f#just) is to escape the escape character, `\`.
