...
Parsing `rule`. Parses a real number to a [`++rn`](urbit-docs/language/hoon/reference/stdlib/3b#rn).
...
Intermediate parsed float converter. Convert a [`++rn`](urbit-docs/language/hoon/reference/stdlib/3b#rn) to [`++dn`](urbit-docs/language/hoon/reference/stdlib/3b#dn).
