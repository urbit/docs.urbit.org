...
Container core for internally-used XML structure types. XML structure types you'd typically use directly are defined in [Standard Library section 5e](5e).
...
See the [Nock documentation](../../../nock/reference/definition) for details.
...
An intermediate Nock computation result. Similar to a [`$toon`](3g#toon) but without a rendered stack trace.
