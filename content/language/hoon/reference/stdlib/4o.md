...
Container core for internally-used XML structure types. XML structure types you'd typically use directly are defined in [Standard Library section 5e](urbit-docs/language/hoon/reference/stdlib/5e).
...
See the [Rune section](urbit-docs/language/hoon/reference/rune) of the Hoon reference for details of what many of these relate to.
...
See the [Nock documentation](urbit-docs/language/nock/reference/definition) for details.
...
An intermediate Nock computation result. Similar to a [`$toon`](urbit-docs/language/hoon/reference/stdlib/3g#toon) but without a rendered stack trace.
...
See the Hoon School lesson on [type polymorphism](urbit-docs/courses/hoon-school/R-metals) for more details.
