...
- [CLI instructions](self-hosted/cli) – Set up Vere, the Urbit runtime, using the command line.

- [Install on the cloud](self-hosted/cloud-hosting) – A step-by-step guide to setting up Urbit on a VPS.

- [Set up a home server](self-hosted/home-servers) – Explore options for running your own dedicated physical Urbit computer.
