...
Note there is a much more comprehensive [cloud hosting guide](urbit-docs/manual/getting-started/self-hosted/cloud-hosting) which walks through setting up Urbit on a [Digital Ocean](https://www.digitalocean.com/) VPS.
...
Learn how to [get around your urbit](urbit-docs/manual/getting-started/additional/getting-around).
