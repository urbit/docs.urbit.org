...
If that happens, wait five or ten minutes and then try again. You should eventually see:
...
- Kep your Urbit runtime up-to-date to take advantage of the latest Landscape and Application over-the-air updates.  See [Step #5 in the CLI guide](urbit-docs/manual/getting-started/self-hosted/cli#5-runtime-upgrades) to update your runtime.

- Learn how to [get around your
urbit](urbit-docs/manual/getting-started/additional/getting-around).
