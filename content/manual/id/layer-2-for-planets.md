...
Once you’ve activated your planet and downloaded your keyfile, you can use it to [boot your ship immediately](urbit-docs/manual/getting-started/self-hosted/cli).
