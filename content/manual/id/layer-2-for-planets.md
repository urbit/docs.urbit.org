...
Once you’ve activated your planet and downloaded your keyfile, you can use it to [boot your ship immediately](https://urbit.org/manual/getting-started/cli).
