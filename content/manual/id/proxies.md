...
The [Urbit HD Wallet](https://developers.urbit.org/glossary/hdwallet) automatically sets proxies for
your Urbit ID.
...
- **Voting proxy**
  ...
  Senate](https://developers.urbit.org/glossary/senate), and this means they can cast votes on new
