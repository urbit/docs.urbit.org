...
- **Management proxy**
  ...
  Can configure or set Arvo networking keys, [factory reset](guide-to-resets), and conduct sponsorship related operations. Planets, stars, and galaxies may all set a management proxy.
