...
Check for latest Urbit version at https://github.com/urbit/urbit/releases. If you're behind, update using [this guide](https://urbit.org/manual/getting-started/cli#updating).
