...
Check for latest Urbit version at https://github.com/urbit/urbit/releases. If you're behind, update using [this guide](/manual/getting-started/self-hosted/self-hosted/cli#updating).
