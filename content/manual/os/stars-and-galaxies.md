...
To boot your galaxy or star, follow our [installation instructions](urbit-docs/manual/getting-started/).
...
See our [cloud hosting instructions](urbit-docs/manual/running/hosting) for instructions on settings up a Digital Ocean droplet.
