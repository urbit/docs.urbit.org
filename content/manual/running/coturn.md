# Coturn Operator Guide {#coturn-operator-guide}
...
## Getting a server, domain, and certificate {#getting-a-server-domain-and-certificate}
...
```
## Configure firewall to open up coturn ports {#configure-firewall-to-open-up-coturn-ports}
...
```
# STUN server port is 3478 for UDP and TCP, and 5349 for TLS. {#stun-server-port-is-3478-for-udp-and-tcp-and-5349-for-tls}
# Allow connection on the UDP port 3478 {#allow-connection-on-the-udp-port-3478}
listening-port=3478
# and 5349 for TLS (secure) {#and-5349-for-tls-secure}
...
total-quota=100
stale-nonce=600
# Path to the SSL certificate and private key. {#path-to-the-ssl-certificate-and-private-key}
cert=/coturn/certs/cert.pem
pkey=/coturn/certs/privkey.pem
# Specify the allowed OpenSSL cipher list for TLS/DTLS connections {#specify-the-allowed-openssl-cipher-list-for-tlsdtls-connections}
...
## Test that coturn is working {#test-that-coturn-is-working}
...
## Configure uturn {#configure-uturn}
