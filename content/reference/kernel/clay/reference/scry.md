...
[`leak`](/system/kernel/clay/reference/data-types#leak) is a Ford cache key used
internally by Clay.
...
See the [`$rave:clay`](/system/kernel/clay/reference/data-types#rave) data
...
[`$flow:clay`](/system/kernel/clay/reference/data-types#flow).
...
[`cone`](/system/kernel/clay/reference/data-types#cone) containing the `dome`s
...
[`zest`](/system/kernel/clay/reference/data-types#zest) specifies whether apps on the
...
dict:clay]`](/system/kernel/clay/reference/data-types#dict) where the head is read
...
This will return the [yaki:clay](/system/kernel/clay/reference/data-types#yaki) of
the specified commit. It takes a
[tako:clay](/system/kernel/clay/reference/data-types#tako).

Example:

Here we scry the [dome:clay](/system/kernel/clay/reference/data-types#dome) for `%`,
...
This will return the [page:clay](/system/kernel/clay/reference/data-types#page) of
some file. It takes a [lobe:clay](/system/kernel/clay/reference/data-types#lobe).
...
takes a [`tako`](/system/kernel/clay/reference/data-types#tako).

Example:

Here we grab the [`dome`](/system/kernel/clay/reference/data-types#dome) for `%`
with a `%v` scry, get the latest
[`tako`](/system/kernel/clay/reference/data-types#tako) and then do a `%s`
`%hash` scry for it.
...
[`cass`](/system/kernel/clay/reference/data-types#cass). The `case` in the
...
[`dome`](/system/kernel/clay/reference/data-types#dome).
...
[`cass`](/system/kernel/clay/reference/data-types#cass) like `[ud=@ud da=@da]`
...
the [`lobe`](/system/kernel/clay/reference/data-types#lobe) hash if it's a file,
