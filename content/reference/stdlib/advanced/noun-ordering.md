...
If `a` and `b` are both atoms, `dor` is equivalent to [`lte`](/language/hoon/reference/stdlib/1a#lte). If they're
...
[`mug`](/language/hoon/reference/stdlib/2e#mug) is the the 31-bit nonzero FNV-1a hash algorithm.
