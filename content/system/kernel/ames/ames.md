...
[Gall](/system/kernel/gall/gall) and [Clay](/system/kernel/clay/clay)
...
using [`+en:sivc:aes:crypto`](/language/hoon/reference/cryptography#en).
...
Here, `our-life` refers to the [`life`](/system/identity/concepts/life-and-rift), or revision
