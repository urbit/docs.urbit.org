...
which can be obtained in our [Arvo kernel tutorial](/system/kernel/arvo#the-kernel).
...
state](/system/kernel/arvo#the-state)) in the kernel documentation, followed by `-time ~s1`
...
see the [Arvo kernel tutorial](/system/kernel/arvo#the-kernel).
...
3bE core](/system/kernel/arvo#section-3be-core), that generated the output:
...
core](/system/kernel/arvo#section-3be-core). This arm is what the Arvo kernel uses to send `card`s,
