...
which can be obtained in our [Arvo kernel tutorial](/system/kernel/arvo/overview#the-kernel).
...
state](/system/kernel/arvo/overview#the-state)) in the kernel documentation, followed by `-time ~s1`
...
see the [Arvo kernel tutorial](/system/kernel/arvo/overview#the-kernel).
...
3bE core](/system/kernel/arvo/overview#section-3be-core), that generated the output:
...
core](/system/kernel/arvo/overview#section-3be-core). This arm is what the Arvo kernel uses to send `card`s,
