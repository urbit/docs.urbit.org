...
This document contains a number of examples of interacting with Clay using its various `task`s. Sections correspond to the general details in the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document.
...
See the [Read and Subscribe](urbit-docs/system/kernel/clay/reference/tasks#warp---read-and-track) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
...
See the [Write and Modify](urbit-docs/system/kernel/clay/reference/tasks#write-and-modify) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
...
See the [Manage Mounts](urbit-docs/system/kernel/clay/reference/tasks#manage-mounts) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
...
See the [Merge Desks](urbit-docs/system/kernel/clay/reference/tasks#merge-desks) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
...
See the [Permissions](urbit-docs/system/kernel/clay/reference/tasks#permissions) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
...
See the [Foreign Ships](urbit-docs/system/kernel/clay/reference/tasks#foreign-ships) section of the [API Reference](urbit-docs/system/kernel/clay/reference/tasks) document for general details.
