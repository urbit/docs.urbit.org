...
[Writing Marks](urbit-docs/system/kernel/clay/guides/marks/writing-marks) - A practical walkthrough of writing a `mark` file.

[Using Marks](urbit-docs/system/kernel/clay/guides/marks/using-marks) - Details of using `mark` conversion gates and `mark` cores in your own code.

[Examples](urbit-docs/system/kernel/clay/guides/marks/examples) - The example code used in the Writing Marks guide.
