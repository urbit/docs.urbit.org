...
Most types of requests require the client provide a valid session cookie which is obtained by authenticating with your ship's web login code. Authentication is documented in the [Authentication](reference/external-api-ref#authentication) section of the [External API Reference](reference/external-api-ref) documentation.
...
Detailed documentation of the channel system's JSON API is provided in the [External API Reference](reference/external-api-ref) document with corresponding examples in the [Guide](guides/guide#using-the-channel-system) document.
...
Details of Eyre's scry API are in the [Scry](reference/external-api-ref#scry) section of the [External API Reference](reference/external-api-ref) document.
...
Their usage is explained in the [%serve](reference/tasks#serve) section of the [Internal API Reference](reference/tasks) documentation and a practical example is provided in the [Generators](guides/guide#generators) section of the [Guide](guides/guide) document.
...
This method is explained in the [%connect](reference/tasks#connect) section of the [Internal API Reference](reference/tasks) document and a detailed example is provided in the [Agents: Direct HTTP](guides/guide#agents-direct-http) section of the [Guide](guides/guide) document.
...
There are three generators - `+eyre/cors/registry`, `|eyre/cors/approve`, and `|eyre/cors/reject` to view, approve, and deny origins respectively from the dojo. Eyre also has [tasks](reference/tasks) to [approve](reference/tasks#approve-origin) and [reject](reference/tasks#reject-origin) origins programmatically, and a number of [scry endpoints](reference/scry) to query them. Examples are also included in the [Managing CORS Origins](guides/guide#managing-cors-origins) section of the Guide document.
