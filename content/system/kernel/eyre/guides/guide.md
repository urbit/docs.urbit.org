# Low-Level Guide {#low-level-guide}
...
Now if we scry for the [approved](../reference/scry.md#cors-approved) CORS `set`:
...
If we scry for the [rejected](../reference/scry.md#cors-rejected) CORS `set`:
...
Now if we scry for the [requests](../reference/scry.md#cors-requests) CORS `set`:
