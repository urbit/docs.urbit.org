...
General documentation of the `task`s and methods described here are available in the [External API Reference](/system/kernel/eyre/reference/external-api-ref) document and the [Internal API Reference](/system/kernel/eyre/reference/tasks) document.
...
It's advisable to have a read through the [External API Reference](/system/kernel/eyre/reference/external-api-ref) before going through these examples.
