...
If you are not familiar with low-level Eyre channel mechanics, please have a read through the [Eyre guide](guide) first.
...
See the [`$channel-event`](../reference/data-types#channel-event) entry in the data type reference for more details.
