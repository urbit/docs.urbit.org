...
This document contains reference information about Eyre's external APIs including [the channel system](#channels) and [scries](#scry). Each section will also have practical examples in the [Guide](../guides/guide) document.
...
See the [Guide](../guides/guide#authenticating) for an example of how to do this using the curl.
...
See the [Using the Channel System](../guides/guide#using-channels) section of the [Guide](../guides/guide) document for a practical example.
...
See the [Scrying](../guides/guide#scrying) section of the [Guide](../guides/guide) document for a practical example.
