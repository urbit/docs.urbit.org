...
This document contains reference information about Eyre's external APIs including [the channel system](#channels) and [scries](#scry). Each section will also have practical examples in the [Guide](urbit-docs/system/kernel/eyre/guides/guide) document.
...
See the [Guide](urbit-docs/system/kernel/eyre/guides/guide#authenticating) for an example of how to do this using the curl.
...
See the [Using the Channel System](urbit-docs/system/kernel/eyre/guides/guide#using-channels) section of the [Guide](urbit-docs/system/kernel/eyre/guides/guide) document for a practical example.
...
See the [Scrying](urbit-docs/system/kernel/eyre/guides/guide#scrying) section of the [Guide](urbit-docs/system/kernel/eyre/guides/guide) document for a practical example.

## Spider

See the [HTTP API](urbit-docs/userspace/threads/guides/http-api) section of the [Threads](urbit-docs/userspace/threads) documentation.
