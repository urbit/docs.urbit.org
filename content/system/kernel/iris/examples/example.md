...
This thread takes a fully qualified URL in a `@t` as an argument. It will ask Iris to fetch the HTTP resource at the given URL by passing it a [%request task](../reference/tasks#request) containing an HTTP GET [$request:http](../../eyre/reference/data-types#requesthttp):
