...
This thread takes a fully qualified URL in a `@t` as an argument. It will ask Iris to fetch the HTTP resource at the given URL by passing it a [%request task](urbit-docs/system/kernel/iris/reference/tasks#request) containing an HTTP GET [$request:http](urbit-docs/system/kernel/eyre/reference/data-types#requesthttp):
