...
General documentation of the `task`s demonstrated here can be found in the [API Reference](urbit-docs/system/kernel/jael/reference/tasks) document, and details of the data types mentioned can be found in the [Data Types](urbit-docs/system/kernel/jael/reference/data-types) document.
