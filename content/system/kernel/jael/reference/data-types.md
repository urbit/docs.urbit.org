...
This is what Jael gives (in a [%public-keys](urbit-docs/system/kernel/jael/reference/tasks#public-keys) `gift`) to subcribers who are tracking public key information for a `set` of `ship`s.
