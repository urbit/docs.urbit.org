...
### Basic Setup (_Mise en place_) {#basic-setup-_mise-en-place_}
...
#### Declare function prototypes in headers. {#declare-function-prototypes-in-headers}
...
#### Produce functions for compilation and linking. {#produce-functions-for-compilation-and-linking}
...
#### Exercise:  Review Jet Code {#exercise-review-jet-code}
...
#### Register the jet symbols and function names. {#register-the-jet-symbols-and-function-names}
...
#### Exercise:  Implement the Other Jets {#exercise-implement-the-other-jets}
...
#### Edit the C Source Code to Add Registration {#edit-the-c-source-code-to-add-registration}
...
#### Edit the C Source Code to Add the `u3we_()` Function {#edit-the-c-source-code-to-add-the-u3we_-function}
...
#### Edit the C Source Code to Add the `u3qe_()` Function {#edit-the-c-source-code-to-add-the-u3qe_-function}

##### Unpacking Nouns {#unpacking-nouns}
...
#### Run the Compiled C/Compiled Hoon Pill {#run-the-compiled-ccompiled-hoon-pill}
