...
- [Eyre External API Reference](../../system/kernel/eyre/reference/external-api-ref.md) - Lower-level documentation of Eyre's external API.
- [Eyre Guide](../../system/kernel/eyre/guides/guide.md) - Lower-level examples of using Eyre's external API with `curl`.
