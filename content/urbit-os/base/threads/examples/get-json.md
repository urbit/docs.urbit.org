...
Since it's an object in an object, we decode them using nested [`ot:dejs-soft:format`](../../../../hoon/reference/zuse/2d_7.md#otdejs-softformat) functions, and the price itself using [`no:dejs-soft:format`](../../../../hoon/reference/zuse/2d_7.md#nodejs-softformat) to produce a `(unit @ta)`:
...
For more information about working with `json`, see the [JSON Guide](../../../../hoon/guides/json-guide.md).
