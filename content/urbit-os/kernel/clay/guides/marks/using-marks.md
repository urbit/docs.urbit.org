...
You can either use these by `%pass`ing Clay a [%warp task](../../reference/tasks.md#warp) "BROKEN_ANCHOR" with the appropriate `care`, or else with a [Clay scry](../../reference/scry.md). In the examples here we've used the latter.
