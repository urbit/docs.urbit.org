...
General documentation of the tasks demonstrated here can be found in the [API Reference](tasks.md) document, and details of the data types mentioned can be found in the [Data Types](data-types.md) document.
