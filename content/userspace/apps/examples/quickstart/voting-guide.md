...
To learn to create an app like this, the first thing to do is learn Hoon. [Hoon School](urbit-docs/courses/hoon-school) is a comprehensive guide to the language, and the best place to start. After learning the basics of Hoon, [App School](urbit-docs/courses/app-school) will teach you everything you need to know about app development.

Along with these self-directed guides, we also run regular courses on both Hoon and app development. You can check the [Courses](urbit-docs/courses) page for details, or join the `~hiddev-dannut/new-hooniverse` group on Urbit.
