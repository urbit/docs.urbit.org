...
Spider has an Eyre binding which allows threads to be run externally via [authenticated](../../../system/kernel/eyre/reference/external-api-ref.md#authentication) "BROKEN_LINK" HTTP POST requests.
...
First we must obtain a session cookie by [authenticating](../../../system/kernel/eyre/guides/guide.md#authenticating) "BROKEN_LINK".
