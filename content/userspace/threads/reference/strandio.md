...
A [`request:http`](urbit-docs/system/kernel/eyre/reference/data-types#requesthttp).
...
A [`client-response:iris`](urbit-docs/system/kernel/iris/reference/data-types#client-response).
...
A pair of `ship` and [`riff:clay`](urbit-docs/system/kernel/clay/reference/data-types#riff).

#### Produces

A [`riot:clay`](urbit-docs/system/kernel/clay/reference/data-types#riot).
...
example](urbit-docs/userspace/threads/examples/main-loop) or the
...
A [`flog:dill`](urbit-docs/system/kernel/dill/reference/data-types#flog)
